...
pros::Motor topLeft(20, MOTOR_GEAR_BLUE, true);
...
pros::Motor bottomLeft(7, MOTOR_GEAR_BLUE, true);
pros::Motor bottomRight(9, MOTOR_GEAR_BLUE, false);
...
//Initialise sensors
pros::Imu inertial(4);
pros::Rotation right_tracker(17);
pros::Rotation back_tracker(8, true);
